...
/** Metadata/receiver substitution confined to Spring MVC's binding/model method pipeline. */
public final class MvcBindingBridge {
    private MvcBindingBridge() { }
    ...
    public static Object receiver(Object bean, Method method) throws Throwable {
        ...
        if (bean == null || bean.getClass() != schema.owner())
            throw new IllegalStateException("Added MVC binding/model method requires a plain "
