...
/** JDK-only external-call boundary for operation methods absent from the loaded class. */
public final class AddedOperationBridge {
    @FunctionalInterface
