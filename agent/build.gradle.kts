...
dependencies {
    add(hibernateTests.implementationConfigurationName, "org.hibernate.orm:hibernate-core:7.4.8.Final")
    add(hibernateTests.implementationConfigurationName, "org.hibernate.orm:hibernate-jcache:7.4.8.Final")
...
dependencies {
    ...
    add(springSixTests.implementationConfigurationName, "org.hibernate.orm:hibernate-core:7.4.8.Final")
