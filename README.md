...
| New service methods with `@PreAuthorize` / `@PostAuthorize` | **Yes for the supported classic Spring Security configuration**: native pre/post authorization follows saved policies and old singleton/CGLIB references. Tested with Spring 5.3.39 / Security 5.7.11; unsupported security infrastructure fails explicitly. [Scope](docs/usage.md#authorization-on-added-service-methods) | Yes (restart) | Not verified here |
